...
## Drei typische Projekte – und was sie kosten

Drei Beispiele aus meiner Praxis, mit gerundeten Richtwerten. Ihr Projekt kann darunter oder darüber liegen – den verbindlichen Festpreis gibt es nach dem Erstgespräch.

### Praxis-Website mit Terminbuchung

**Anforderung:** Eine Praxis im Gesundheitsbereich will Online-Terminbuchung. Die bestehende WordPress-Site ist langsam und wartungsintensiv.

**Umfang:** Komplette Neuentwicklung, Buchungslogik mit Verfügbarkeitsprüfung, Bestätigungs-Mails, DSGVO-konforme Datenspeicherung in der EU.

**Richtwert:** 3.500 bis 5.000 Euro einmalig, kein Wartungsvertrag. Dazu kommen nur die laufenden Hostingkosten.

**Ergebnis:** Patient:innen buchen direkt online statt über ein Kontaktformular.

### Kompakte Praxis-Visitenkarte

**Anforderung:** Eine selbständige Therapeutin braucht ihre erste Website.

**Umfang:** Fünf bis sechs Seiten, für Mobilgeräte optimiert, SEO-Grundlagen, Kontaktformular.

**Richtwert:** 599 bis 1.200 Euro einmalig, Hosting ab 99 Euro pro Jahr.

**Lieferzeit:** ein bis zwei Wochen.

### Web-Anwendung für einen Dienstleistungsbetrieb

**Anforderung:** Digitales Backoffice – Kundenverwaltung, Personalplanung, Tablet-Oberfläche für Besichtigungen vor Ort, Zeiterfassung für Mitarbeiter:innen.

**Umfang:** Mehrere zusammenhängende Anwendungen, Datenbank, mobile Web-App.

**Richtwert:** ab 15.000 Euro, abhängig vom Funktionsumfang.

**Ergebnis:** Angebote entstehen direkt bei der Besichtigung statt nachträglich im Büro.
