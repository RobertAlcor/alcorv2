...
export const FAQS: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      'Das Starter-Paket beginnt bei 599 Euro und umfasst eine vollständige Website mit bis zu fünf Seiten. Größere Projekte werden individuell kalkuliert – mit Festpreis vor Projektstart, keine Überraschungen. Die genauen Pakete sehen Sie auf der Preise-Seite.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Ratenzahlung ist grundsätzlich möglich, das besprechen wir im Erstgespräch. Wenn auch eine Rate nicht stemmbar ist, dann passen wir vermutlich nicht zusammen – und das ist okay. In dem Fall verweise ich gerne auf günstigere Alternativen wie Baukasten-Lösungen. Die sind nicht das, was ich mache, aber für sehr kleine Budgets oft der richtige Weg.',
  },
  {
    question: 'Wie lange dauert ein Projekt?',
    answer:
      'Das Starter-Paket liefere ich typischerweise in sieben Werktagen. Größere Projekte mit individuellen Funktionen brauchen entsprechend länger – oft zwei bis vier Wochen. Den genauen Zeitrahmen vereinbaren wir vor Projektstart verbindlich.',
  },
  {
    question: 'Kann ich zusehen, wie die Website entsteht?',
    answer:
      'Ja, gerne. Die Seite wird auf einer Subdomain entwickelt, zu der Sie jederzeit Zugriff haben. Sie sehen den Live-Stand bei jedem meiner Arbeitsschritte und können laufend Feedback geben. Das vermeidet die typische Situation, in der am Ende etwas geliefert wird, das nicht den Vorstellungen entspricht.',
  },
  {
    question: 'Können wir die Pläne für die neue Website persönlich durchgehen?',
    answer:
      'Selbstverständlich. Das Erstgespräch findet je nach Wunsch persönlich in Wien, telefonisch oder per Videocall statt – ohne Verkaufsdruck und kostenlos. Auch während der Umsetzung können wir uns jederzeit treffen, falls etwas am Live-Stand zu besprechen ist.',
  },
  {
